  ...
  return (
    <a
      ...
      className={`group relative flex w-[280px] shrink-0 flex-col overflow-hidden rounded-2xl border sm:w-[300px] lg:w-[320px] ${
        isDark
          ? "border-white/8 bg-[#0A1018]/80 hover:border-[#00D8A5]/30"
          : "border-slate-200 bg-white shadow-sm hover:border-teal-300 hover:shadow-md"
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        <span className="absolute right-3 top-3 rounded-md border border-emerald-500/20 bg-emerald-500/10 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-emerald-400">
          {app.status}
        </span>
      </div>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <ArrowUpRight
            className={`h-3.5 w-3.5 shrink-0 opacity-0 transition-all group-hover:opacity-100 ${
              isDark ? "text-[#00D8A5]" : "text-teal-600"
            }`}
          />
        </div>
        <h3
  ...
  return (
    ...
    >
      <div className={`${containerClass} space-y-10`}>
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            <span className="inline-block text-[10px] font-black uppercase tracking-[0.2em] text-[#00D8A5]">
              Ecosystem
            </span>
            <h2
      ...
      <div className="relative mt-10">
        ...
        <div className="apps-marquee-track flex w-max gap-5 px-6 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24">
