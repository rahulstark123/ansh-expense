...
import { ECOSYSTEM_LINKS } from "@/lib/landing-seo";
import {
  BRAND_BTN_CTA,
  BRAND_BTN_PRIMARY,
  brandGradientText,
    ...
    <div className={`landing-page min-h-screen overflow-x-hidden ${themeBg} font-sans ${themeText} ${s.selection} transition-colors duration-300 ${isDark ? "landing-dark" : ""}`}>
            ...
            <div className={`rounded-3xl border ${isDark ? "border-zinc-800 bg-zinc-900" : "border-zinc-200 bg-white shadow-sm"} p-8 flex flex-col justify-between space-y-6 relative ${a.cardHover} transition-all text-left`}>
              <div className="space-y-6">
                ...
                <ul className={`space-y-3.5 pt-2 text-[13px] font-semibold ${isDark ? "text-slate-300" : "text-slate-700"}`}>
                  ...
                  <li className={`flex gap-2.5 items-start ${isDark ? "text-slate-500" : "text-slate-450"}`}>
        ...
        <div className={`${LANDING_CONTAINER} space-y-16`}>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className={`rounded-3xl border ${s.cardSurfaceHover} p-8 space-y-6 flex flex-col justify-start transition-all duration-300`}>
              ...
              <div className="space-y-2">
                <h3 className={`text-base font-black uppercase tracking-wider ${isDark ? "text-white" : "text-slate-855"}`}>Compared to Zoho Expense</h3>
            ...
            <div className={`rounded-3xl border ${s.cardSurfaceHover} p-8 space-y-6 flex flex-col justify-start transition-all duration-300`}>
              ...
              <div className="space-y-2">
                <h3 className={`text-base font-black uppercase tracking-wider ${isDark ? "text-white" : "text-slate-855"}`}>Compared to Concur & Expensify</h3>
            ...
            <div className={`rounded-3xl border ${s.cardSurfaceHover} p-8 space-y-6 flex flex-col justify-start transition-all duration-300`}>
              ...
              <div className="space-y-2">
                <h3 className={`text-base font-black uppercase tracking-wider ${isDark ? "text-white" : "text-slate-855"}`}>Compared to Excel & Slack</h3>
                <p className={`text-[11px] sm:text-xs ${isDark ? "text-slate-500" : "text-slate-555"} font-extrabold leading-normal`}>
          ...
          <div className="grid gap-6 md:grid-cols-12 pt-6">
            ...
            <div className={`md:col-span-5 rounded-3xl border ${isDark ? "border-white/5 bg-zinc-900/40" : "border-zinc-200 bg-white/40 shadow-sm"} p-8 space-y-4 flex flex-col justify-center`}>
              ...
              <p className={`text-xs sm:text-sm ${isDark ? "text-slate-400" : "text-slate-655"} leading-relaxed font-semibold`}>
                  ...
                  <div className="p-5 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4.5 min-w-0">
                      <div className={`h-9 w-9 rounded-xl flex items-center justify-center shrink-0 border transition-colors ${isCurrent
                        ? `${a.badgeSoft} ${a.text}`
                        : `${isDark ? "bg-zinc-955/60 border-white/5" : "bg-zinc-100 border-zinc-200"} text-zinc-500`
                        }`}>
      ...
      <footer className={`relative z-10 border-t ${themeBorder} ${s.footerBg} pt-20 pb-12 overflow-hidden`}>
        <div className={`${LANDING_CONTAINER} space-y-16`}>
          ...
          {/* Footer Columns */}
          <div className={`grid gap-8 sm:grid-cols-2 md:grid-cols-5 pt-12 border-t ${themeBorder}`}>
            {/* Col 1 */}
            ...
            <div className="space-y-4 text-left">
              ...
              <ul className={`space-y-2 text-[11px] font-semibold ${isDark ? "text-slate-400" : "text-slate-655"}`}>
            ...
            {/* Col 3: Ecosystem (Cross-links) */}
            <div className="space-y-4 text-left">
              <span className={`block text-[10px] font-bold ${isDark ? "text-slate-500" : "text-slate-455"} uppercase tracking-widest`}>Ecosystem</span>
              <ul className={`space-y-2 text-[11px] font-semibold ${isDark ? "text-slate-400" : "text-slate-650"}`}>
                {ECOSYSTEM_LINKS.map((item) => (
                  <li key={item.name}>
                    {item.name === "ANSH Expense" ? (
                      <span className={`${isDark ? "text-zinc-500" : "text-zinc-400"} cursor-default font-black`}>ANSH Expense</span>
                    ) : (
                      <a
                        href={item.url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`${isDark ? "hover:text-white" : "hover:text-slate-955"} transition-colors inline-flex items-center gap-1`}
                      >
                        {item.name}
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="flex flex-col gap-2 pt-1">
                <a
                  ...
                  className={`flex w-fit items-center gap-2 text-[11px] font-bold ${a.mail} transition-colors`}
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`flex w-fit items-center gap-2 text-[11px] font-bold ${isDark ? "text-green-400 hover:text-green-300" : "text-green-600 hover:text-green-700"} transition-colors`}
                >
          ...
          <div className={`flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t ${themeBorder} text-[10px] font-semibold ${themeTextMutedLighter}`}>
            ...
            <div className="flex gap-6 uppercase tracking-wider">
              <Link href="/privacy" className={`${isDark ? "hover:text-slate-355" : "hover:text-slate-800"} transition-colors`}>Privacy Policy</Link>
              <Link href="/terms" className={`${isDark ? "hover:text-slate-355" : "hover:text-slate-800"} transition-colors`}>Terms of Service</Link>
              <Link href="/help" className={`${isDark ? "hover:text-slate-355" : "hover:text-slate-800"} transition-colors`}>Contact Us</Link>
            </div>
          </div>
        </div>
      </footer>
